...
class Jcart {
	...
	*/
	public function display_cart() {
		...
		echo tab(7) . "<span id='jcart-subtotal'>{$config['text']['subtotal']}: <strong>Rs." . number_format($this->subtotal, $priceFormat['decimals'], $priceFormat['dec_point'], $priceFormat['thousands_sep']) . "</strong></span>\n";
		echo tab(6) . "</th>\n";
		echo tab(5) . "</tr>\n";
		echo tab(4) . "</tfoot>\n";			
